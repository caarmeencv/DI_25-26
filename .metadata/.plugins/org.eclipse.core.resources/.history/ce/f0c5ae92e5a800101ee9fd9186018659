...
public class Exercicio04_AdivinhaONumero extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		btnProba.setOnAction(e -> {
			...
			if (aleatorio > numero && numero >= 0) {
				...
				msg.setBackground(new Background (new BackgroundFill(Color.LIGHTGREEN, null, null)));;
			} else {
		...
		btnRendirse.setOnAction(e -> {
			...
			msg.setBackground(new Background (new BackgroundFill(Color.LIGHTCORAL, null, null)));;
			msgContador.setText(" ");
		});
		...
		btnReiniciar.setOnAction(e -> {
			...
			contador = 0;
			msgContador.setText(" ");
			msg.setBackground(new Background (new BackgroundFill(null, null, null)));;
